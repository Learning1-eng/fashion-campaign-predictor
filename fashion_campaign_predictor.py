...
st.markdown('<style>input[type="range"]{accent-color:#111!important;}input[type="range"]::-webkit-slider-runnable-track{background:#111!important;height:3px!important;}input[type="range"]::-webkit-slider-thumb{background:#C8D400!important;-webkit-appearance:none!important;width:18px!important;height:18px!important;border-radius:50%!important;margin-top:-8px!important;}[data-baseweb="tab-highlight"]{background-color:#111111!important;}[data-baseweb="tab-border"]{background-color:#E8E8E4!important;}</style>', unsafe_allow_html=True)
